...
const HOST_CONTEXT_START = "<pulsar-assistant-host-context>";
const HOST_CONTEXT_END = "</pulsar-assistant-host-context>";
...
export class AgentSession {
  ...
  async prompt(
    ...
    try {
      ...
      // attached from this client. The text block is skipped when empty so a
