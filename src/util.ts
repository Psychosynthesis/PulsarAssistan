...
// Holds a spawned process plus its ring-buffered output. Output is a single
// merged stdout+stderr buffer truncated from the beginning (oldest dropped)
// once it exceeds the byte limit, kept at a UTF-8 + line boundary.
